...
def main():
    ...
    # Definir la ruta de la carpeta de documentos en función del proyecto
    folder_path = os.path.join(project_root, "documentos")
    
    # Parámetros de procesamiento
    ngram_size = 3  # Tamaño de n-gramas (2 para bi-gramas, 3 para tri-gramas, etc.)
    top_n = 6       # Número de pares a mostrar
    
    # Paso 1 y 2: Cargar, limpiar y tokenizar documentos en n-gramas
    ...
    # Paso 4: Comparar documentos y calcular la similitud de Jaccard
    ...
    # Paso 6: Mostrar los top N pares de documentos más similares en consola
